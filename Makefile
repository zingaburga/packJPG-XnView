...
LIBYUV_LIB = libyuv/libyuv.a

DEPS = $(PACKJPG_LIB) xnview/xpjg.o $(LIBJPEG_LIB) $(LIBYUV_LIB)
CFLAGS = -Wall -Wl,--kill-at -s -O2 -shared -static-libgcc -static-libstdc++
CPPFLAGS = $(CFLAGS) -Ilibyuv/include -o $(XNVIEW_PLUGIN) $(DEPS)
...
xnview/xpjg.o: xnview/xpjg.c
	cd xnview
	gcc -Ilibyuv/include -Wall -march=i686 -O3 -o $@ -c $^
